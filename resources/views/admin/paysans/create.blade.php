                        ...
                        <div class="col-lg-6">
                            <div>
                                <div class="form-group mb-4">
                                    ...
                                    <input id="input-nom" type="text" class="form-control input-mask" name="nom">
                                    {!! $errors->first('nom','<span class="error">:message</span>') !!}
                                </div>
                                <div class="form-group mb-4">
                                    <label for="input-prenom">prenom</label>
                                    <input id="input-prenom" type="text" class="form-control input-mask" name="prenom">
                                    {!! $errors->first('prenom','<span class="error">:message</span>') !!}
                                </div>
                                <div class="form-group mb-4">
                                    <label for="input-numero">contact</label>
                                    <input id="input-numero" type="number" class="form-control input-mask" name="numero">
