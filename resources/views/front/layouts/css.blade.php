 <!-- favicons Icons -->
    ...
    <link rel="stylesheet" href="{{ asset('front/assets/vendors/agrion-icons/style.css') }}">
    ...
    <!-- template styles -->
    <link rel="stylesheet" href="{{ asset('front/assets/css/agrion.css') }}" />
    <link rel="stylesheet" href="{{ asset('front/assets/css/agrion-responsive.css') }}" />
